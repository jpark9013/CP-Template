...
constexpr int32_t _MOD = 1e9 + 7;
using mod = Modular<std::integral_constant<decay<decltype(_MOD)>::type, _MOD>>;
...
// using mod = Modular<VarMod>; 
// later, do cin >> VarMod.value;
